package gov.smart.health.activity.vr.downloadfile.download;
...
import gov.smart.health.activity.vr.downloadfile.Utils.LogUtils;
import gov.smart.health.activity.vr.downloadfile.Utils.StringUtils;
...
public class DownloadThread extends Thread {
    ...
    public void run() {
        ...
        List<DownloadFileInfo> downloadFileInfos = SQLite.select().from(DownloadFileInfo.class).queryList();
